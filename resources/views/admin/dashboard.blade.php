                        ...
                        <ul class="list-group list-group-media">
                            <li class="list-group-item ">
                                <div class="media">
                                    <div class="me-3">
                                        <img alt="avatar"
                                            src="https://designreset.com/cork/html/src/assets/img/netflix.svg"
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="me-3">
                                        <img alt="avatar"
                                            src="https://designreset.com/cork/html/src/assets/img/apple-app-store.svg"
                                            class="img-fluid rounded-circle">
                                    </div>
                                    <div class="media-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="../src/assets/img/profile-13.jpg" alt="avatar"><span>Luke
                                                        Ivory</span></div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="../src/assets/img/profile-7.jpg" alt="avatar"><span>Andy
                                                        King</span></div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="../src/assets/img/profile-10.jpg" alt="avatar"><span>Laurie
                                                        Fox</span></div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="../src/assets/img/profile-5.jpg" alt="avatar"><span>Ryan
                                                        Collins</span></div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="../src/assets/img/profile-4.jpg" alt="avatar"><span>Irene
                                                        Collins</span></div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="../src/assets/img/profile-11.jpg" alt="avatar"><span>Sonia
                                                        Shaw</span></div>
                                            </td>
                                            <td>
                                ...
                                <table class="table table-scroll">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="../src/assets/img/product-shoes.jpg" alt="product">
                                                    <div class="align-self-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="../src/assets/img/product-watch.jpg" alt="product">
                                                    <div class="align-self-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="../src/assets/img/product-laptop.jpg" alt="product">
                                                    <div class="align-self-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="../src/assets/img/product-camera.jpg" alt="product">
                                                    <div class="align-self-center">
                                            ...
                                            <td>
                                                <div class="td-content"><a href="javascript:void(0);"
                                                        class="text-secondary"><svg xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" stroke="currentColor" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round"
