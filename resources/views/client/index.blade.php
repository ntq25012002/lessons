                ...
                <div class="col-xxl-6 col-lg-6">
                    <div class="slider__thumb-2 p-relative">
                        <div class="slider__shape">
                            {{-- <img class="slider__shape-1" src="assets/img/slider/2/shape/slider-cap-1.png"
                                alt="">
                            <img class="slider__shape-2" src="assets/img/slider/2/shape/slider-cap-2.png"
                                alt="">
                            <img class="slider__shape-3" src="assets/img/slider/2/shape/slider-cap-3.png"
                                alt="">
                            <img class="slider__shape-4" src="assets/img/slider/2/shape/slider-shape-1.jpg"
                                alt="">
                            <img class="slider__shape-5" src="assets/img/slider/2/shape/slider-shape-2.jpg"
                                alt=""> --}}
                        </div>
                                        ...
                                        <a href="course-v1.html">
                                            <svg width="30" height="30" viewBox="0 0 30 30"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#4270FF" stroke-width="1.56"
                                        ...
                                        <a href="course-v1.html">
                                            <svg width="32" height="32" viewBox="0 0 32 32"
                                                ...
                                                <path d="M16 25.225V19.015" stroke="#FF6470" stroke-width="1.6"
                                                    stroke-linecap="round" />
                                                <path d="M23.6799 25.225V15.895" stroke="#FF6470"
                                                    stroke-width="1.6" stroke-linecap="round" />
                                                <path
                                        ...
                                        <a href="course-v1.html">
                                            <svg width="27" height="29" viewBox="0 0 27 29"
                                                ...
                                                <path
                                                    ...
                                                    stroke-linejoin="round" />
                                                <path d="M7.375 8.08331H18.7083" stroke="#E33CFF"
                                                    stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M8.79175 13.75H17.2917" stroke="#E33CFF"
                                                    stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path
                        ...
                        <nav>
                            <div class="nav nav-tabs justify-content-center" id="course-tab" role="tablist">
                                <button class="nav-link active" id="nav-all-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="nav-all" aria-selected="true">All Category</button>
                                ...
                                <button class="nav-link" id="nav-design-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="nav-design" aria-selected="false">Design Architect</button>
                            </div>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="tab-content course__tab-content" id="course-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-design" role="tabpanel"
                            ...
                            <div class="research__content-2 p-relative z-index-1">
                                ...
                                <div class="research__store">
                                    <ul>
                                        <li>
                                            <a href="#">
                                                {{-- <img src="assets/img/icon/google-play-store.png"
                                                    alt="google-play-store">  --}}
                                                    Google play</a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                {{-- <img src="assets/img/icon/apple-store.png"
                                                    alt="apple-store"> --}}
                                                    Apple store</a>
                                        </li>
                                    </ul>
                    ...
                    <div
                        ...
                        <div class="event__left d-sm-flex align-items-center">
                            ...
                            <div class="event__content">
                                ...
                                <h3 class="event__title">
                                    <a href="event-details.html">Virtual spring part-time jobs fair for
                                        student.</a>
                                </h3>
                    ...
                    <div
                        ...
                        <div class="event__left d-sm-flex align-items-center">
                            ...
                            <div class="event__content">
                                ...
                                <h3 class="event__title">
                                    <a href="event-details.html">Scottish creatives to receive funded
                                        business.</a>
                                </h3>
