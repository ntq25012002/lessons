                ...
                <div class="col-xxl-7 col-xl-7 col-lg-7">
                    <div class="about__thumb-wrapper d-sm-flex mr-20 p-relative">
                        <div class="about__shape">
                            <img class="about__shape-1 d-none d-sm-block" src="assets/img/about/about-shape-1.png"
                                alt="">
                            <img class="about__shape-2 d-none d-sm-block" src="assets/img/about/about-shape-2.png"
                                alt="">
                        ...
                        <div class="course__content p-relative">
                            ...
                            <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                <div class="course__tutor">
                                    <a href="#"><img src="assets/img/course/tutor/course-tutor-1.jpg"
                                            alt="">Brian Cumin</a>
                                </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                    <div class="course__item white-bg transition-3 mb-30">
                        ...
                        <div class="course__content p-relative">
                            ...
                            <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                <div class="course__tutor">
                                    <a href="#"><img src="assets/img/course/tutor/course-tutor-2.jpg"
                                            alt="">Jack Morkel</a>
                                </div>
                                <div class="course__lesson">
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                    <div class="course__item white-bg transition-3 mb-30">
                        ...
                        <div class="course__content p-relative">
                            ...
                            <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                <div class="course__tutor">
                                    <a href="#"><img src="assets/img/course/tutor/course-tutor-3.jpg"
                                            alt="">Hilary Ouse</a>
                                </div>
                                <div class="course__lesson">
                                    <a href="#"><svg width="14" height="16" viewBox="0 0 14 16"
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                    <div class="course__item white-bg transition-3 mb-30">
                        ...
                        <div class="course__content p-relative">
                            ...
                            <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                <div class="course__tutor">
                                    <a href="#"><img src="assets/img/course/tutor/course-tutor-4.jpg"
                                            alt="">Phanta Bear</a>
                                </div>
                                <div class="course__lesson">
                                    <a href="#"><svg width="14" height="16" viewBox="0 0 14 16"
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                    <div class="course__item white-bg transition-3 mb-30">
                        ...
                        <div class="course__content p-relative">
                            ...
                            <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                <div class="course__tutor">
                                    <a href="#"><img src="assets/img/course/tutor/course-tutor-5.jpg"
                                            alt="">Hilary Ouse</a>
                                </div>
                                <div class="course__lesson">
                                    <a href="#"><svg width="14" height="16" viewBox="0 0 14 16"
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                    <div class="course__item white-bg transition-3 mb-30">
                        ...
                        <div class="course__content p-relative">
                            ...
                            <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                <div class="course__tutor">
                                    <a href="#"><img src="assets/img/course/tutor/course-tutor-6.jpg"
                                            alt="">Oliver Porter</a>
                                </div>
                                <div class="course__lesson">
                                    <a href="#"><svg width="14" height="16" viewBox="0 0 14 16"
                        ...
                        <div class="testimonial__active owl-carousel">
                            <div class="testimonial__item transition-3 text-center white-bg">
                                ...
                                <div class="testimonial__text">
                                    <h4>Great quality!</h4>
                                    <p>Lorem ipsum dolor sit amet, consectet adipiscing elit. Phasellus feugiat lacus vitae
                                        neque ornare.</p>
                                </div>
